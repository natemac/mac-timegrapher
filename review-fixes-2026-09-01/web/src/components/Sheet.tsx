...
/*
   Open sheets form a stack: an InfoSheet can sit above SettingsSheet. Each
   instance still owns its listener, but only the top one may handle Escape.
   stopPropagation() cannot provide that guarantee because both listeners are
   attached to the same Window target.
*/
