...
emit() { # environment output
	emcc -O3 \
		...
		-s EXPORTED_FUNCTIONS='["_tgw_init","_tgw_push","_tgw_result","_tgw_events","_tgw_waveform","_tgw_waveform_fields","_tgw_waveform_points","_tgw_cal_fields","_tgw_cal_begin","_tgw_cal_update","_tgw_cal_end","_tgw_reset","_tgw_destroy","_tgw_version","_tgw_result_fields","_malloc","_free"]'
}
